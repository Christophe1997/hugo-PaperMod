...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}})());hljs.registerLanguage("scala",(()=>{"use strict";return e=>{const n={
...
begin:"@[A-Za-z]+"}]}}})());hljs.registerLanguage("cpp",(()=>{"use strict";return e=>{const t=(e=>{
...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("scheme",(()=>{"use strict";return e=>{
var t="[^\\(\\)\\[\\]\\{\\}\",'`;#|\\\\\\s]+",n={$pattern:t,
...
contains:[e.SHEBANG(),a,i,l,g,d].concat(c)}}})());hljs.registerLanguage("fsharp",(()=>{"use strict";return e=>{const n={begin:"<",
